...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schoolreport_school', (
            ...
            ('school_status', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ...
            ('municipality', self.gf('django.db.models.fields.CharField')(max_length=100)),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 5, 5, 21, 8, 665405)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 5, 5, 21, 8, 665268)'}),
