...
urlpatterns = patterns('',
    ...
    url(r'^browse/$', 'schoolreport.views.browse', name='browse'),
    url(r'^school/$', 'schoolreport.views.school', name='school'),
    url(r'^page/(?P<page>\d+)/$', 'schoolreport.views.home', name='home'),
    url(r'^join/$', 'schoolreport.auth.join', name='join'),
    url(r'^schoollist/$', 'schoolreport.auth.schoollist', name='schoollist'),
